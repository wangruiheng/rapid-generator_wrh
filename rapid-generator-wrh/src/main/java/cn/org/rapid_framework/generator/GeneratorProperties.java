...
public class GeneratorProperties {
	...
	static final String PROPERTIES_FILE_NAMES = "generator.xml";
	...
	public static void reload() throws IOException {
		GLogger.println("Start Load GeneratorPropeties from classpath:"+PROPERTIES_FILE_NAMES);
		Properties p = new Properties();
		p = PropertiesHelper.loadAllPropertiesFromClassLoader(p,PROPERTIES_FILE_NAMES);
		setProperties(p);
	}
